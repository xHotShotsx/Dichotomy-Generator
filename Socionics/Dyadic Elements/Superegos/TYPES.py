...
def report_unique_xnor(
    ...
    out_path: str = "Socionics/Dyadic Elements/Superegos/xnor_unique_report.txt"
):
...
if __name__ == "__main__":
    path = "Socionics/Dyadic Elements/Superegos/superego_splits_n8.txt"
    compare = [1, 21, 24]  # placeholder, adjust as needed
    kept_inputs, rows, out_file = report_unique_xnor(path, compare, out_path="Socionics/Dyadic Elements/Superegos/xnor_unique_report.txt")
