...
def report_unique_xnor(
    ...
    out_path: str = "Socionics/Dyadic Elements/Activators/xnor_unique_report.txt"
):
...
if __name__ == "__main__":
    path = "Socionics/Dyadic Elements/Activators/activator_splits_n8.txt"
    compare = [1]  # placeholder, adjust as needed
    kept_inputs, rows, out_file = report_unique_xnor(path, compare, out_path="Socionics/Dyadic Elements/Activators/xnor_unique_report.txt")
