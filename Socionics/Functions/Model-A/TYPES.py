...
def report_unique_xnor(
    ...
    out_path: str = "Socionics/Functions/Model-A/xnor_unique_report.txt"
):
...
if __name__ == "__main__":
    path = "Socionics/Functions/Model-A/model_a_function_splits_n8.txt"
    compare = [1, 21, 24]  # placeholder, adjust as needed
    kept_inputs, rows, out_file = report_unique_xnor(path, compare, out_path="Socionics/Functions/Model-A/xnor_unique_report.txt")
